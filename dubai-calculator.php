<?php
/**
 * Plugin Name: Cost Calculation form
 * Description: A custom lead-capture form for business setup in Dubai via shortcode [dubai_setup_calculator].
 * Version: 1.0.0
...
class Dubai_Setup_Calculator {

    public function __construct() {
        add_action('wp_enqueue_scripts', array($this, 'enqueue_assets'));
        add_shortcode('dubai_setup_calculator', array($this, 'render_shortcode'));
        
        add_action('wp_ajax_submit_dubai_calculator', array($this, 'handle_ajax_submission'));
        add_action('wp_ajax_nopriv_submit_dubai_calculator', array($this, 'handle_ajax_submission'));
    ...
    public function map_avada_element() {
        if (function_exists('fusion_builder_map')) {
            fusion_builder_map(array(
                ...
                'shortcode'       => 'dubai_setup_calculator',
    ...
    public function enqueue_assets() {
        ...
        wp_enqueue_style('dubai-calculator-css', plugin_dir_url(__FILE__) . 'assets/style.css', array(), $css_ver);
        wp_enqueue_script('dubai-calculator-js', plugin_dir_url(__FILE__) . 'assets/script.js', array(), $js_ver, true);
        
        wp_localize_script('dubai-calculator-js', 'dubaiCalcObj', array(
            'ajax_url' => admin_url('admin-ajax.php'),
            'nonce'    => wp_create_nonce('dubai_calculator_nonce')
        ));
    }
    ...
    public function handle_ajax_submission() {
        check_ajax_referer('dubai_calculator_nonce', 'nonce');
